...
def main():
    ...
    if len(sys.argv) > 2 and sys.argv[2] == 'new':
        if host + '.json' in os.listdir(os.path.join('headers', 'login')): 
            os.remove(os.path.join('headers', 'login', host + '.json'))
